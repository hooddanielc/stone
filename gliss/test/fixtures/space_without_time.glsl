// http://glslsandbox.com/e#42741.0
#ifdef GL_ES
...
void main( void ) {
  ...
  vec3 color =  mix(vec3(0.1, 0.1, 0.1),  vec3(0.1, 0.1, 0.2),  pow(a, 0.1)) * 2.0;
  color +=  mix(vec3(0.1, 0.1, 0.1),  vec3(0.1, 0.1, 0.2),  pow(b, 0.1)) * 1.5;
  color +=  mix(c2,       vec3(0.1, 0.2, 0.2),  pow(c, 0.1)) * 1.2;
