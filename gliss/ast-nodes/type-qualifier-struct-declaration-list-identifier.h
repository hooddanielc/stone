...
class type_qualifier_struct_declaration_list_identifier_t: public ast_node_t {
...
public:
  ...
  type_qualifier_struct_declaration_list_identifier_t(
...
const std::vector<std::vector<any_pattern_item_t>> type_qualifier_struct_declaration_list_identifier_t::patterns = {
  {
