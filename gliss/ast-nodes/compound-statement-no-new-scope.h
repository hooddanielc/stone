...
public:
  ...
  struct pattern<n, typename std::enable_if<n == 0>::type> {
    using type = compound_statement_no_new_scope_left_brace_right_brace_t;
    static std::vector<std::shared_ptr<any_pattern_item_t>> list;
  };

  template<int n>
  struct pattern<n, typename std::enable_if<n == 1>::type> {
    using type = compound_statement_no_new_scope_left_brace_statement_list_right_brace_t;
    static std::vector<std::shared_ptr<any_pattern_item_t>> list;
  };
...
template <>
std::vector<std::shared_ptr<any_pattern_item_t>> compound_statement_no_new_scope_t::pattern<0>::list = {
...
template <>
std::vector<std::shared_ptr<any_pattern_item_t>> compound_statement_no_new_scope_t::pattern<1>::list = {
  pattern_item_t<token_t>::get(token_t::uppercase_to_kind("LEFT_BRACE")),
